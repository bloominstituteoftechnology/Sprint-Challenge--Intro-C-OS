...
1. Managing the hardware's resources such as the processors, memory, storage, etc...

2. On multi user systems, the OS is responsible for ensuring only those with the correct permissions
can access resources.

3. Managing files and folders.

4. Managing network and network devices.
