...
Any of the OS has three major functions:
  *1. Manage the computer resources: CPU, memory, disk drives, printers etc..
  *2. Establishing user interface
  *3. Execute and provide services for applications softeware.
